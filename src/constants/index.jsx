...
// 5 vertical channels (targeted user segments)
...
export const AGENT_CATEGORIES = ['全部', '分析', '技术', '商业', '创作', '语言', '教育', '思辨'];
...
export const MATERIAL_TYPES = { quote: '金句', data: '数据', case: '案例', viewpoint: '观点', chart: '图表' };
